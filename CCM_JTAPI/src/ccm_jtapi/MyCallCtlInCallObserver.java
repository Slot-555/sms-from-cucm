...
for (int i = 0; i < evlist.length; i++) {
    if (evlist[i].getCause() == CallCtlEv.CAUSE_CALL_NOT_ANSWERED ) { System.out.println("Потомучта не отвечаешь а?"); }
    ...
    System.out.println(evlist[i].getID()); // CallCtlConnFailedEv
}
}
}
